...
input_files = ['MapRecoloring.cs', #'Extensions.cs',
'_Commons\\Algorithms\\Maps.cs', '_Commons\\Algorithms\\Geometry.cs']#, '_Commons\\Algorithms\\Commons.cs'] #'GameState.cs', 'World.cs', 'Result.cs', 'Actions.cs']
